        ...
        <nav class="navbar navbar-expand-sm bg-danger navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-center col-6" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="textnav nav-item px-5">
                        <a <?php if($_SERVER['REQUEST_URI'] == "/PHP.page/Plat.php")echo ' class="textnav nav-link active"';else echo ' class="textnav nav-link"'?> href="Plat.php" title="Plat">Plat</a>
                    </li>
                    <li class="textnav nav-item px-5">
                        <a <?php if($_SERVER['REQUEST_URI'] == "/PHP.page/contact.php")echo ' class="textnav nav-link active"';else echo ' class="textnav nav-link"'?> href="contact.php" title="Contact">Contact</a>
                    </li>
                </ul>
            </div>
        </nav>
